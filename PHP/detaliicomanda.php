...
<head>
    ...
    <link rel="stylesheet" href="detaliicomanda_styles.css"> <!--CSS styles-->
    <script src="login.js"></script> <!--cod JavaScript pentru validare nume si parola-->
   
    <title>DetaliiComanda</title>
</head>
<body>
    ...
    <div class="number">
        <div class="text">Total inregistrari: 
            <?php
             ...
             $sql = "SELECT count(IDComanda) as total from detaliicomanda";
   ...
   <table>
       <thead>
        ...
        <?php
            ...
            $sql="SELECT * from detaliicomanda";
            $result=mysqli_query($conn,$sql);

            if(mysqli_num_rows($result)>0){
                while($row=mysqli_fetch_array($result)) {
                    echo "<tbody>";
                    echo "<tr><td>".$row['NumarBucatiComandate']."</td></tr>";
               echo "</tbody>";
           }
       }
            $conn->close();
...
<div id="dialogbox">
  <div>
    ...
    <div id="insert-form">
            <form class="box" action="insert_detaliicomanda.php" method="post">
            <input type="text" id="insert" name="idcom" placeholder="IDComanda">
            <input type="text" id="insert" name="idar" placeholder="IDArticol">
            <input type="text" id="inserts" name="nr" placeholder="NumarBucatiComandate">
            <input type="submit" name="" value="Adauga date">
            </form>
    </div>
    
    <div id="update-form">
    <form class="box" action="update_detaliicomanda.php" method="post">
    <input type="text" id="cautare1" name="idcom" placeholder="Cautare dupa id comanda">
            <input type="text" id="modificare" name="nr" placeholder="Modifica numar bucati comandate">
            <input type="submit" name="update" value="Modifica date">
        </form>
    </div>

    <div id="delete-form">
    <form class="box" action="delete_detaliicomanda.php" method="post">
    <input type="text" id="stergere" name="nr" placeholder="Cautare dupa numar bucati comandate">
