...
<head>
    ...
    <link rel="stylesheet" href="facturi_styles.css"> <!--CSS styles-->
...
<body>
    ...
    <div class="number">
        <div class="text">Total inregistrari: 
            <?php
             ...
             $sql = "SELECT count(IDFactura) as total from facturi";
   ...
   <table>
       <thead>
        <tr>
            <th>Data emiterii facturii</th>
            <th>Seria facturii</th>
            <th>Numarul facturii</th>
        </tr>
     </thead> 
        <?php
            //conectare la baza de date  
...
<div id="dialogbox">
  <div>
    ...
    <div id="insert-form">
            <form class="box" action="insert_facturi.php" method="post">
            <input type="text" id="insert" name="idf" placeholder="IDFactura">
            <input type="text" id="insert" name="dataef" placeholder="DataEmitereFactura">
            <input type="text" id="insert" name="sf" placeholder="SerieFactura">
            <input type="text" id="insert" name="nf" placeholder="NumarFactura">
            <input type="submit" name="" value="Adauga date">
            </form>
    </div>
    
    <div id="update-form">
    <form class="box" action="update_facturi.php" method="post">
            <input type="text" id="cautare" name="sf" placeholder="Cautare dupa serie factura">
            <input type="text" id="modificare" name="dataef" placeholder="Modifica data emitere factura">
            <input type="text" id="modificare" name="nf" placeholder="Modifica numar factura">
            <input type="submit" name="update" value="Modifica date">
        </form>
    </div>

    <div id="delete-form">
    <form class="box" action="delete_facturi.php" method="post">
            <input type="text" id="stergere" name="sf" placeholder="Cautare dupa serie factura">
