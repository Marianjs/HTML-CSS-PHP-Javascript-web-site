...
<head>
    ...
    <link rel="stylesheet" href="categorii_styles.css"> <!--CSS styles-->
    ...
    <div class="number">
        <div class="text">Total inregistrari: 
            <?php
             ...
             $sql = "SELECT count(IDCategorie) as total from categorii";
        ...
        <?php
            ...
            if(mysqli_num_rows($result)>0){
                while($row=mysqli_fetch_array($result)) {
                    echo "<tbody>";
                    echo "<tr><td>".$row['NumeCategorie']."</td><td>".$row['DescriereCategorie']."</td></tr>";
               echo "</tbody>";
           }
       }
            $conn->close();
...
<div id="dialogbox">
  <div>
    ...
    <div id="insert-form">
            <form class="box" action="insert_categorii.php" method="post">
            <input type="text" id="insert" name="idcateg" placeholder="IDCategorie">
            <input type="text" id="insert" name="numecateg" placeholder="NumeCategorie">
            <input type="text" id="insert" name="desccateg" placeholder="DescriereCategorie">
            <input type="submit" name="" value="Adauga date">
            </form>
    </div>
    
    <div id="update-form">
    <form class="box" action="update_categorii.php" method="post">
    <input type="text" id="cautare" name="numecateg" placeholder="Cautare dupa numele categoriei">
            <input type="text" id="modificare" name="desccateg" placeholder="Modifica descrierea categoriei">
            <input type="submit" name="update" value="Modifica date">
        </form>
    </div>

    <div id="delete-form">
    <form class="box" action="delete_categorii.php" method="post">
            <input type="text" id="stergere" name="numecateg" placeholder="Cautare dupa numele categoriei">
