...
<head>
    ...
    <link rel="stylesheet" href="furnizori_styles.css"> <!--CSS styles-->
    ...
    <div class="number">
        <div class="text">Total inregistrari: 
            <?php
             ...
             $sql = "SELECT count(IDFurnizor) as total from furnizori";
   ...
   <table>
       <thead>
        <tr>
            ...
            <th>Tara furnizorului</th>
            <th>Localitatea furnizorului</th>
            <th>Strada furnizorului</th>
            <th>Numar de telefon furnizor</th>
        </tr>
     </thead> 
        <?php
            //conectare la baza de date  
...
<div id="dialogbox">
  <div>
    ...
    <div id="insert-form">
            <form class="box" action="insert_furnizori.php" method="post">
            <input type="text" id="insert" name="idfrn" placeholder="IDFurnizor">
            <input type="text" id="insert" name="denfrn" placeholder="DenumireFurnizor">
            <input type="text" id="insert" name="tarafrn" placeholder="TaraFurnizor">
            <input type="text" id="insert" name="locfrn" placeholder="LocalitateFurnizor">
            <input type="text" id="insert" name="sfrn" placeholder="StradaFurnizor">
            <input type="text" id="insert" name="tfrn" placeholder="TelefonFurnizor">
            <input type="submit" name="" value="Adauga date">
            </form>
    </div>
    
    <div id="update-form">
    <form class="box" action="update_furnizori.php" method="post">
            <input type="text" id="cautare" name="denfrn" placeholder="Cautare dupa denumire furnizor">
            <input type="text" id="modificare" name="tarafrn" placeholder="Modifica tara furnizor">
            <input type="text" id="modificare" name="locfrn" placeholder="Modifica localitate furnizor">
            <input type="text" id="modificare" name="sfrn" placeholder="Modifica strada furnizor">
            <input type="text" id="modificare" name="tfrn" placeholder="Modifica telefon furnizor">
            <input type="submit" name="update" value="Modifica date">
        </form>
    </div>

    <div id="delete-form">
    <form class="box" action="delete_furnizori.php" method="post">
            <input type="text" id="stergere" name="denfrn" placeholder="Cautare dupa denumire furnizor">
